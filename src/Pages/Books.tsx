			...
			<div className="container" style={container}>
				<div className="row mt-5">
					...
					<div className="col-lg-3 text-center">
						...
						<button className="button mt-3 w-80 btn btn-lg btn-outline-primary mb-3" onClick={recommendRandomBook}>
					...
					<div className="col-lg-6">
						...
						<div className="card-body">
							...
							<p className="card-text" id="game_resume">{gameSummary}</p>

							<ul className="mt-3">
								<li className=""><b>Genres:</b> <span id="game_genres">{gameGenres.join(', ')}</span></li>
								<li className=""><b>Platforms:</b> <span id="game_platforms">{gamePlatforms.join(', ')}</span></li>
								<li className=""><b>Developer:</b> <span id="game_developer">{gameDeveloper}</span></li>
								<li className=""><b>Publisher:</b> <span id="game_developer">{gamePublisher}</span></li>
							</ul>
						</div>
					...
					<div className="col-lg-3 mb-3">
						...
						<form className="mb-3" action="/searchGame" method="GET">
							<input className="shadow-sm fs-5 form-control" type="search" placeholder="Search Book Title..." aria-label="Search" name="title" />
						</form>

						<div className="list-group shadow-sm">
							<a href="/" className="d-flex justify-content-between list-group-item list-group-item-action">
								<i className="bi bi-controller"></i>
								<span>Games</span>
								<span>123</span>
							</a>

							<a href="/books" className="d-flex justify-content-between list-group-item list-group-item-action text-white bg-dark">
