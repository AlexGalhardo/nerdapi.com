			...
			<div className="col-lg-6 mt-5">
				...
				<div id="credit-card" className="tab-pane fade show active">
					...
					<div className="form-group mb-2">
						...
						<div className="input-group">
							<input type="text" name="card_number" placeholder="Credit Card Number" className="form-control" defaultValue="4242424242424242" required />
					...
					<div className="row">
						...
						<div className="col-sm-8">
							<div className="form-group mt-4">
								...
								<div className="input-group">
									<input type="number" placeholder="Month" name="card_exp_month" min="1" max="12" step="1" className="form-control" defaultValue="08" required />
									<input type="number" placeholder="Year" name="card_exp_year" min="2023" step="1" className="form-control" required defaultValue="2023" />
								</div>
							</div>
						</div>
						<div className="col-sm-4" style={cvv}>
							<div className="form-group mb-2">
								...
								<input type="text" name="card_cvc" required className="form-control" placeholder="Code CVV" defaultValue="314" />
							</div>
						</div>
					</div>
