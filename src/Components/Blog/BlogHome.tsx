        ...
        <>
            <div className="container col-md-8">
                <form action="/blog/search" method="GET" className="d-flex mt-5 mb-5">
                    <input
                        className="fs-4 w-100 form-control me-2 shadow"
                        type="search"
                        ...
                        required
                    />
                    <button className="fs-5 btn btn-outline-dark button fw-bold" type="submit">
                        Search
                    </button>
                </form>
                    ...
                    <div className="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow h-md-250 position-relative">
                        <div className="col p-4 d-flex flex-column position-static">
                            ...
                            <p className="card-text mb-auto">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsum molestiae blanditiis
                                sapiente nostrum quisquam modi quod, facere itaque perspiciatis error beatae officiis et
                                eius. Quam amet voluptas optio nobis expedita.
                            </p>
                        </div>
                    </div>
                </a>
